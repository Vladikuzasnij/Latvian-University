# Programmas nosaukums: Naivās kārtošanas metode
# 4./5. uzdevums (1MPR05_Vladislavs_Babaņins)
# Uzdevuma formulējums: Sastādīt programmu, kas pieprasa lietotājam ievadīt N skaitļus un sakārto tos dilstošā (neaugošā) secībā, izmantojot naivās kārtošanas metodi un uz ekrāna izvada sakārtoto skaitļu masīvu un veikto salīdzināšanas skaitu.
# Sastādīt programmu, kas pieprasa lietotājam ievadīt N skaitļus un sakārto tos dilstošā (neaugošā) secībā, izmantojot burbuļa kārtošanas metodi un uz ekrāna izvada sakārtoto skaitļu masīvu un veikto salīdzināšanas skaitu.
...
c = b
print("Paveikts salīdzīnašanas skaits, lai sakārtot masīvu: (naivais dilstoša)")
naivais_dilstosa(b)  # Salidzinašanas skaits
print("Paveikts salīdzīnašanas skaits, lai sakārtot masīvu: (burbulis uzlabotais)")
burbulis_uzlabotais(c)
